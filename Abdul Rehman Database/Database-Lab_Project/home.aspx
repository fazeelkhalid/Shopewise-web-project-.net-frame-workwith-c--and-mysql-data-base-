					    ...
					    <div class="tab_slider tab-content">
							    ...
							    <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
									...
									<div class="item">
									    <div class="product_wrap">
										    <span class="pr_flash bg-danger"><%=item.product_Id%></span>
										    <div class="product_img">
											    <a href="shop-product-detail.html">
												    <img src="<%=item.product_profileImage %>" alt="el_img1">
												    <img class="product_hover_img" src="<%=item.product_demoImage %>"" alt="el_hover_img1">
											    </a>
										    ...
										    <div class="product_info">
											    <h6 class="product_title"><a href="shop-product-detail.html"><%=item.product_Name %></a></h6>
											    <div class="product_price">
												    <span class="price">RS <%=item.product_price%></span>
												    <%--<del>$55.25</del>
												    <div class="on_sale">
													    <span>35% Off</span>
												    </div>--%>
											    ...
											    <div class="rating_wrap">
												    ...
												    <span class="rating_num">(<%=item.product_rating %>)</span>
											    </div>
											    <div class="pr_desc">
						    ...
						    <div class="tab-pane fade" id="sellers" role="tabpanel" aria-labelledby="sellers-tab">
							    <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
									...
									<% foreach (var item in best_seller_list) { %>
									<div class="item">
									    <div class="product_wrap">
										    <span class="pr_flash bg-danger"><%=item.Seller_Id%></span>
										    <div class="product_img">
											    <a href="shop-product-detail.html">
												    <img src="<%=item.Seller_profileImage%>" alt="el_img1">
											    </a>
											    <div class="product_action_box">
												    <ul class="list_none pr_action_btn">
													    <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
										    ...
										    <div class="product_info">
											    <h6 class="product_title"><a href="shop-product-detail.html"><%=item.Seller_Name%></a></h6>
											    <div class="product_price">
												    <span class="price"><%=item.Seller_description%></span>
											    ...
											    <div class="rating_wrap">
												    ...
												    <span class="rating_num">(<%=item.Seller_rating%>)</span>
											    </div>
											    <div class="pr_desc">
