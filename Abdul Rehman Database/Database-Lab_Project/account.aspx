				    ...
				    <div class="col-lg-3 col-md-4">
					    <div class="dashboard_menu">
						    <ul class="nav nav-tabs flex-column" role="tablist">
						      ...
						      <li class="nav-item">
								  <asp:LinkButton class="nav-link" onclick="Logout" runat="server"> <i class="ti-lock"></i>Logout </asp:LinkButton>
						      </li>
						    </ul>
					    </div>
				    </div>
									    ...
									    <form method="post" name="enq">
										    <div class="row">
											    <div class="form-group col-md-6">
                                                    ...
                                                    <asp:TextBox ID="Text1" class="form-control" name="name" type="text" runat="server" MaxLength="32"></asp:TextBox>
											     </div>

                                                
											    <div class="form-group col-md-6">
												    <label>Change Phone Number</label>
                                                    <asp:TextBox ID="Text2" class="form-control" name="name" type="text" runat="server" minLength="11" MaxLength="32"></asp:TextBox>
											     </div>

                                                <div class="form-group col-md-6">
												    <label>Change City</label>
                                                    <asp:TextBox ID="Text3" class="form-control" name="name" type="text" runat="server" MaxLength="32"></asp:TextBox>
											     </div>

                                                <div class="form-group col-md-6">
												    <label>Change Address</label>
                                                    <asp:TextBox ID="Text4" class="form-control" name="name" type="text" runat="server" MaxLength="80"></asp:TextBox>
											     </div>

												<div class="form-group col-md-6">
												    <label>Change Email</label>
                                                    <asp:TextBox ID="Text5" class="form-control" name="name" type="text" runat="server" MaxLength="32"></asp:TextBox>
                                                </div>

											    <div class="form-group col-md-6">
												    <label>Old Password</label>
                                                    <asp:TextBox ID="Text6" class="form-control" name="name" type="password" placeholder="(Required)" runat="server" MaxLength="32"></asp:TextBox>
                                                </div>

                                                <div class="form-group col-md-6">
												    <label>New Password</label>
                                                    <asp:TextBox ID="Text7" class="form-control" name="name" type="password" runat="server" MaxLength="32"></asp:TextBox>
                                                </div>

                                                
                                                <div class="form-group col-md-6">
												    <label>Re-enter Password</label>
                                                    <asp:TextBox ID="Text8" class="form-control" name="name" type="password" runat="server" MaxLength="32"></asp:TextBox>
                                                </div>
